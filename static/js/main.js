var yourDateToGo = new Date(Date.UTC(2019, 10, 22, 0, 0, 0)); //here you're making new Date object
...
var timing = setInterval( // you're making an interval - a thing, that is updating content after number of miliseconds, that you're writing after comma as second parameter
  function () {
    ...
    if (timeLeft <= 0) {
      ...
      document.getElementById("countdown").innerHTML = "Competition over"; //if there's no time left, programm in this 2 lines is clearing interval (nothing is counting now)
